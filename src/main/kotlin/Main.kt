...
Классы не разнес по разным модулям
Ошибки о которых я знаю:
Нужно больше уделить внимание проверке структуры возвращаемого JSON
data.size может быть меньше per_page
